...
final class RootRouter: LaunchRouter<RootInteractable, RootViewControllable>, RootRouting {
    ...
    func routeToExperience(experience: Experience) {
        ...
        currentRIB?.viewControllable.uiviewController.dismiss(animated: true) { [weak self] in
            self?.viewControllable.uiviewController.present(viewController, animated: true)
        }
